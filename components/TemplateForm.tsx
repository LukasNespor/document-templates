...
import { FileText, FolderOpen, StickyNote, Edit3, Wand2, AlertCircle, Loader2, Download, Edit2, Trash2, Upload } from "lucide-react";
...
export default function TemplateForm({ template, onGenerate, onEditTemplate, onDeleteTemplate, onReuploadTemplate, onHelp }: TemplateFormProps) {
