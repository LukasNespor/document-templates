...
import { FileText, Upload, HelpCircle, LogOut, User, Users } from "lucide-react";
...
export default function TopBar({ onAddTemplate, onHelp, onHome, username, isAdmin, onLogout, onProfileClick, onManageUsers }: TopBarProps) {
  return (
    <div
          ...
          {username && (
            <>
              ...
              {onLogout && (
                <button
                  onClick={onLogout}
                  className="bg-red-600/80 hover:bg-red-600 px-4 py-2.5 rounded-lg font-medium transition-all flex items-center gap-2 backdrop-blur-sm"
                  title="Odhlásit se"
                >
